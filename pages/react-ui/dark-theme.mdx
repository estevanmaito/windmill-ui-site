...
Windmill, when used with the enclosing `Windmill` component, offers out of the box the following features:
...
In Windmill, multi theme is part of the core, so to make it easier for you to change between styles, it exposes a way for you to toggle and to read the current theme through React's Context API, as long as you have `Windmill` enclosing your root component.
...
Recommendation #1: Think of your design as if they were layers: elements closer to the user should use a lighter gray while farther ones should use darker shades. [This tweet](https://twitter.com/steveschoger/status/1151160261170126850/photo/1) from Steve Schoger shows it better than words.
