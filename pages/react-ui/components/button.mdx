...
There are four sizes, applied by the prop `size`: `larger`, `large`, `regular` (default), `small` and `icon`.
...
| ---------- | ------------------------------ | --------------------------------------------- | --------- |
| `size`     | define the size of component   | `larger`, `large`, `regular`, `small`, `icon` | `regular` |
